...
<template>
  <header>
    ...
    >
      <span class="hidden md:block" aria-label="Gå till startsidan">Icon</span>
    ...
    >
      <div><p aria-label="Gå till startsidan">icon</p></div>
      <div>
        <router-link to="/login" aria-label="Gå till logga in"
