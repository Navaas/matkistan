...
<template>
  <header
    v-if="isLoggedIn"
    class="flex px-2 py-2 bg-[#385F4E] text-white cursor-pointer justify-between fixed bottom-0 left-0 w-full md:top-0 md:bottom-auto z-50"
  >
  ...
  <div
    v-else="!isLoggedIn"
    class="flex justify-between px-2 py-2 bg-[#385F4E] text-white cursor-pointer fixed top-0 left-0 w-full"
  >
  ...
  <div
    v-if="isLoggedIn"
    class="flex px-2 py-2 bg-[#385F4E] text-white cursor-pointer justify-between fixed bottom-0 left-0 w-full md:top-0 md:bottom-auto z-100"
  >
